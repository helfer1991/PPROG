 ...
 * @author HMCFB
 */
public class ProfessorCoordenador extends Professor implements Pagamentos {
    private static double majoracao = 0.5;
    
    public ProfessorCoordenador(String nome, int id) {
        super(nome, id);
    }
